...
$currenturl = new moodle_url('/enrol/programs/management/source_approval_reject.php', ['id' => $id]);
...
$form = new \enrol_programs\local\form\source_approval_reject(null, ['request' => $request, 'user' => $user, 'program' => $program, 'context' => $context]);
...
if ($data = $form->get_data()) {
    enrol_programs\local\source\approval::reject_request($request->id, $data->reason);
