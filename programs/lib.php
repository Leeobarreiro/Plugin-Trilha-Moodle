...
function render_progress_bar($studentid) {
    global $USER;

    $progress = calculate_student_progress($studentid);

    // Verifique as permissões do usuário
    if (has_capability('moodle/site:config', context_system::instance()) || $USER->id == $studentid) {
        // Renderize a barra de progresso
