...
$currenturl = new moodle_url('/enrol/programs/management/program_visibility_edit.php', ['id' => $id]);
...
$form = new \enrol_programs\local\form\program_visibility_edit(null, ['data' => $current, 'context' => $context]);

$returnurl = new moodle_url('/enrol/programs/management/program_visibility.php', ['id' => $program->id]);
