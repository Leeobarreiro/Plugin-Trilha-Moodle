...
final class allocation {
    ...
    public static function calculate_average_progress($programid, $userid) {
        global $DB, $USER;
    ...
    public static function update_user(stdClass $allocation): stdClass {
        ...
        $isCourseCompleted = self::check_program_completion($allocation->userid, $allocation->programid);

    if ($isCourseCompleted) {
        $record->timecompleted = time(); // Definir a data/hora atual como a data de conclusão
    }
    ...
    private static function check_program_completion($userid, $programid) {
        global $DB;
    
        // Obter o progresso geral do programa
        $averageProgress = self::calculate_average_progress($programid, $userid);
