 ...
 */
final class source_approval_approve extends \local_openlms\dialog_form {
    protected function definition() {
        ...
        $this->add_action_buttons(true, get_string('source_approval_requestapprove', 'enrol_programs'));
    }
