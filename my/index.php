...
if (!$programs) {
    $catalogueLink = new moodle_url('/enrol/programs/catalogue/index.php');
    echo "Você ainda não está inscrito em nenhuma trilha, <a href='{$catalogueLink}'>clique aqui</a> para acessar o catálogo de trilhas.";
    echo $OUTPUT->footer();
    die;
}
