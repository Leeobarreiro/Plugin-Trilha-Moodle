...
$PAGE->set_url(new moodle_url('/enrol/programs/catalogue/source_selfallocation.php', ['sourceid' => $sourceid]));
...
if (!\enrol_programs\local\source\selfallocation::can_user_request($program, $source, $USER->id)) {
...
$form = new enrol_programs\local\form\source_selfallocation(null, ['source' => $source, 'program' => $program]);
...
if ($data = $form->get_data()) {
    enrol_programs\local\source\selfallocation::signup($program->id, $source->id);
